Namespace CoreServices.WindowsApiInterop.Enums
    ...
    ''' </list>
    ''' <para>
    ''' Note: The start type defines when the service is started and whether it starts automatically or manually, or if it is disabled.
    ''' </para>
    ...
    ''' </remarks>
    Public Enum StartType As UInteger
